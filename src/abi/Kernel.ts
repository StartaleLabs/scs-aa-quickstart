export const Kernel = [
  ...
  { inputs: [], name: "SignerPrefixNotPresent", type: "error" },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "moduleTypeId", type: "uint256" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "uint32", name: "nonce", type: "uint32" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "PermissionId", name: "permission", type: "bytes4" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "PermissionId", name: "permission", type: "bytes4" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "ValidationId", name: "rootValidator", type: "bytes21" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "ValidationId", name: "vId", type: "bytes21" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "contract IValidator", name: "validator", type: "address" },
      { indexed: false, internalType: "uint32", name: "nonce", type: "uint32" },
    ],
  ...
  { stateMutability: "payable", type: "fallback" },
  {
    inputs: [],
    name: "accountId",
    outputs: [{ internalType: "string", name: "accountImplementationId", type: "string" }],
  ...
  {
    inputs: [{ internalType: "contract IExecutor", name: "executor", type: "address" }],
    name: "executorConfig",
    outputs: [
      {
        components: [{ internalType: "contract IHook", name: "hook", type: "address" }],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "PolicyData[]", name: "policyData", type: "bytes22[]" },
        ],
